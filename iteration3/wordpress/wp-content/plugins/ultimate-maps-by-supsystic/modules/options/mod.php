				...
				'general' => array(
					...
					'opts' => array(
						'def_engine' => array('label' => __('Maps Engine', UMS_LANG_CODE), 'desc' => __('Select required Maps Engine to drive your maps.', UMS_LANG_CODE), 'def' => 'leaflet', 'html' => 'selectbox',
							...
							'rapidapi_key' => array('label' => __('MapTiles RapidAPI Key', UMS_LANG_CODE), 'desc' => sprintf(__('Get your Rapid API key free or paided <a href="%s" target="_blank">here</a>', UMS_LANG_CODE), 'https://rapidapi.com/MapTilesApi/api/maptiles/pricing/'), 'def' => '', 'html' => 'text'/*, 'connect' => 'def_engine:bing'*/),
