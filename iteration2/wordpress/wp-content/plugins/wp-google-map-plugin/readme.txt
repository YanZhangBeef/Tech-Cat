...
Plugin Name:       WP MAPS
Tags: wordpress org map, map, maps, google maps, wp google maps, google map plugin, wordpress google maps, google maps api, map markers, custom markers, google maps wordpress, google maps embed, custom infowindow, map locations, store locator 
...
= 4.4.4 =
  Please update to 4.4.4 or above to use the most stable version of the plugin.

= 4.4.3 =
  Please update to 4.4.3 or above to use the most stable version of the plugin.
  
= 4.4.2 =
  Please update to 4.4.2 or above to use the most stable version of the plugin.

= 4.4.1 =
  Please update to 4.4.1 or above to use the most stable version of the plugin.

== Changelog ==

= 4.4.4 =
* Fix : Database engine & characterset collate related issue fixed.

= 4.4.3 =
* Fix : Security issue fixed related to deletion of a location, category or map.
...
= 4.4.0 =
* Fix : Security issuse related to [display_map] shortcode fixed.
