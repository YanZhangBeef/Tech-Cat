<div class="supsystic-overview">
			<div class="full-page">
				<div class="plugin-title"><img src="<?php echo UMS_PLUGINS_URL .'/'. UMS_PLUG_NAME;?>/modules/supsystic_promo/img/plugin-icon.png">Ultimate Maps By Supsystic</div>
			...
			<div class="half-page half-page-left">
					<div class="border-wrapper">
						<ul>
							...
							<li class="overview-section-btn"><a target="_blank" title="Go to supsystic.com" href="https://supsystic.com/plugins/ultimate-maps/?utm_source=plugin&utm_campaign=ultimate-maps"> Plugin page on supsystic.com <sup><i class="fa fa-external-link"></i></sup></a></li>
							<li class="overview-section-btn"><a target="_blank" title="Go to supsystic.com" href="https://supsystic.com/plugins/ultimate-maps/?utm_source=plugin&utm_campaign=ultimate-maps"> Compare FREE and PRO features <sup><i class="fa fa-external-link"></i></sup></a></li>
							<li class="overview-section-btn"><a target="_blank" title="Go to supsystic.com" href="https://supsystic.com/all-plugins/?utm_source=plugin&utm_campaign=ultimate-maps"> Check other supsystic FREE plugins <sup><i class="fa fa-external-link"></i></sup></a></li>
						</ul>
					</div>
					<div class="border-wrapper">
					...
					<div data-section="faq" class="faq-list overview-section">
							...
							<?php }?>
							<div style="clear: both;"></div>
							<a target="_blank" href="https://supsystic.com/docs/ultimate-maps-documentation/?utm_source=plugin&utm_medium=faq&utm_campaign=ultimate-maps" class="button button-primary button-hero">
									<i class="fa fa-info-circle"></i>
									Check all FAQs
							</a>
							<div class="clear"></div>
			...
			<div class="half-page half-page-right">
					<a href="https://supsystic.com/pricing/?utm_source=plugin&utm_campaign=ultimate-maps" target="_blank"><img class="overview-supsystic-img" src="<?php echo UMS_PLUGINS_URL .'/'. UMS_PLUG_NAME;?>/modules/supsystic_promo/img/overview-01.png"></a>
					<a href="https://supsystic.com/bundle-mix/?utm_source=plugin&utm_campaign=ultimate-maps" target="_blank"><img class="overview-supsystic-img" src="<?php echo UMS_PLUGINS_URL .'/'. UMS_PLUG_NAME;?>/modules/supsystic_promo/img/overview-02.png"></a>
					<a href="https://supsystic.com/all-plugins/?utm_source=plugin&utm_campaign=ultimate-maps" target="_blank"><img style="margin-top:20px;"  class="overview-supsystic-img" src="<?php echo UMS_PLUGINS_URL .'/'. UMS_PLUG_NAME;?>/modules/supsystic_promo/img/overview-03.png"></a>
					<div class="clear"></div>
			</div>
			</div>
	</div>
